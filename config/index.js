module.exports = {
  ...
  siteTitle: 'Daniel Minimal Blog', // Navigation and Site Title
  siteTitleAlt: 'Daniel Minimal Blog', // Alternative Site title for SEO
  ...
  siteDescription: 'Daniel Minimal Blog. Articles about latest technologies', // Your site description
  author: 'Daniel', // Author for schemaORGJSONLD
  siteLogo: '/social/logo.png', // Image for schemaORGJSONLD

  // siteFBAppID: '123456789', // Facebook App ID - Optional
  userTwitter: '@danielkapexhiu', // Twitter Username - Optional
  ogSiteName: 'danielminimalblog', // Facebook Site Name - Optional
